...
public class GetStartedSample {
    ...
    private static String key = "flow/logo.png";
    private static File uploadFile = new File("/Users/qianlong/Desktop/CRM Demo/logo.png");
...
//            PutObjectResult putObjectResult = ossClient.putObject(new PutObjectRequest(bucketName, key, uploadFile));
//            System.out.println("File Url:" + putObjectResult.getResponse().getUri());
//
//            /*
